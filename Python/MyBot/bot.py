...
URL_VK = 'https://api.vk.com/method/wall.get?domain=just_str&count=10&filter=owner'
FILE_NAME_VK = 'last_known_id.txt'
BASE_POST_URL = 'https://vk.com/wall-106084026_'
BOT_TOKEN = '317677128:AAFRe2LKO7gfV2k5JmfvpTBh-gCEOZVSIbQ'
CHANNEL_NAME = '@channelpt'
SINGLE_RUN = False
...
def check_new_posts_vk():
    ...
    with open(FILE_NAME_VK, 'rt') as file:
    ...
    try:
        ...
        if feed is not None:
            ...
            with open(FILE_NAME_VK, 'wt') as file:
                try:
                    tmp = entries[0]['is_pinned']
